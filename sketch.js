...
var GameOverSond, KnifeSwooshSond;
...
function preload(){
  ...
  //carregue o som aqui
  GameOverSond = loadSound("gameover.mp3");
  KnifeSwooshSond = loadSound("knifeSwoosh.mp3");
}
  ...
  if(gameState===PLAY){
    ...
    else
    {
      ...
      if(monsterGroup.isTouching(knife)){
        ...
        knife.x=300;
        knife.y=300;
        knife.changeAnimation("gameOverImage", 300, 300, 10, 10);
      }
    }
  }
